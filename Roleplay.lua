...
addon.roleplayPhrases = {
  ...
  scoundrel = {
    pick_success = {
      ...
      "rebalances {target}'s personal finances in favor of someone more personally invested.",
      "liberates a few coins before their present owner can spend them irresponsibly.",
    },
    pick_empty = {
    ...
    pick_failure = {
      ...
      "declares the incident a misunderstanding of aggressively flexible property law.",
      "withdraws with the dignity of a gentleman leaving the wrong bedroom.",
    },
    envenom = {
      ...
      "toasts {target} with a blade carrying a suspiciously expensive vintage.",
    },
    eviscerate = {
      ...
      "guides the blade neatly through a gap in {target}'s defenses.",
      "settles the dispute by declaring {target} in breach of an agreement nobody signed.",
    },
    kick = {
      ...
      "evicts {target}'s spell before it can finish moving in.",
      "corrects {target}'s casting posture with a boot and unsolicited expertise.",
    },
    gouge = {
      ...
      "recalibrates {target}'s depth perception with alarming confidence.",
    },
    blind = {
      ...
      "produces a portable patch of darkness from a surprisingly small pocket.",
      "orders {target} to follow directions that are suddenly unavailable.",
    },
    ambush = {
      ...
      "appears behind {target} without declaring any useful intentions.",
      "emerges from the shadows like a man following directions he invented moments ago.",
    },
    garrote = {
      ...
      "ties an unnecessarily elaborate knot around {target}'s remaining objections.",
      "demonstrates that rope remains persuasive in almost any professional setting.",
    },
    cheap_shot = {
      ...
      "cites an extremely convenient footnote in a code he wrote moments ago.",
      "fights as fairly as an honest card game.",
    },
    vanish = {
    ...
    sap = {
      ...
      "sends {target} somewhere quiet for a nap, location not included.",
      "declares an unscheduled break for {target} and enforces it immediately.",
    },
    ranged = {
    ...
    victory = {
      ...
      "claims administrative jurisdiction and declines to explain the applicable law.",
      "looks for loose coin, the nearest exit, and a plausible alibi, in that order.",
    },
  },
  venom = {
    pick_success = {
